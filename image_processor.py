...
# Define dataset path (ensure it contains 'real' and 'fake' subdirectories)
...
# Save trained model
model.save("fake_news_image_model.h5")

print("Model saved successfully as fake_news_image_model.h5")
